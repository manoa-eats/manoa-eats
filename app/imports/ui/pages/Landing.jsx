      ...
      <div className={'digits-landing-background'}>
        <Grid container centered stackable columns={3}>
          <Grid.Column textAlign='center'>
            ...
            <Header as="h3" inverted > This address book enables any number of users to register and have their business contacts. You can only see the contacts you have created. </Header>
          </Grid.Column>
          <Grid.Column textAlign='center'>
